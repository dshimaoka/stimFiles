function SS = stimFlashedBarRandNoiseTS(myScreenInfo,Pars)
...
if Pars(12)+Pars(17)>100 || Pars(13)-Pars(17)<-100
...
myScreenStim2 = ScreenStim.Make(myScreenInfo,'stimRandNoiseTS' ,Pars2);

SS = Putinfront( myScreenInfo, myScreenStim1, myScreenStim2);
SS.Type = x.Name;
SS.Parameters = Pars;
...
x = XFile.Load('stimFlashedBarRandNoiseTS');
Pars = x.ParDefaults;
Pars(1) = 20;
SS = ScreenStim.Make(myScreenInfo,'stimFlashedBarRandNoiseTS',Pars);
