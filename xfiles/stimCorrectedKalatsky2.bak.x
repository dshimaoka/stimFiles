...
2	start	"                    Stimulus start (deg)"	0	-180-180 1+
3	end	"                      Stimulus end (deg)"	0	-180-180 1+
4	tf	"            Temporal frequency (Hz *100)"	100	1-400 1+
...
11	ori	"         Orientation (xpos = 1;ypos = 2)"  1   1-2 1+
