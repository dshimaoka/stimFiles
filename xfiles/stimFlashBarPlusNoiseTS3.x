...
3	wid	"                      Bar width (deg*10)"	75	1-900 1+
4	pos	"Position relative to center of screen (deg*10)"	-450	-900-900 1+
...
11	x1	"       Left border, from center (deg*10)"	0	-2000-2000 1+
12	x2	"      Right border, from center (deg*10)"	0	-2000-2000 1+
13	nfr	"    NOISE: Number of frames per stimulus"	20	1-150 1+
14	sqsz	"         NOISE: Size of squares (deg*10)"	125	1-400 1+
