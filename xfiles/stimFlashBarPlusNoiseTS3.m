function SS = stimFlashBarPlusNoiseTS3(myScreenInfo,Pars)
...
x = XFile('stimFlashBarPlusNoise',pp);% this needs to be 'XFile('stimFlashBarPlusNoise3',pp)'?? 20141126
...
myScreenStim2 = ScreenStim.Make(myScreenInfo,'stimRandNoiseTS3' ,Pars2);
