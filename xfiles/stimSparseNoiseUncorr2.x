#
#	stimSparseNoiseUncorr2
#
#
foo nonperiodic	11
#
0	dur	"               Stimulus duration (s *10)"	50	1-36000 1+
1	x1	"       Left border, from center (deg*10)"	-400	-1350-1350 1+
2	x2	"      Right border, from center (deg*10)"	400	-1350-1350 1+
3	y1	"     Bottom border, from center (deg*10)"	-200	-1000-500 1+
4	y2	"        Top border, from center (deg*10)"	200	-500-1000 1+
5	nfr	"              Number of frames per image"	10	1-120 1+
