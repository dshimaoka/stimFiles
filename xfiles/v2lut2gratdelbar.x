...
#	v2lut2gratdelbar
#
#	for a pair of drifting/flickering sine gratings in rectangular windows (with initial delay)
#
...
8	sizex1		"Patch 1 Inner Diameter (deg*10)"	10	0-300 1+
9	sizey1		"Patch 1 Outer Diameter (deg*10)"	80	0-400 1+
...
18	sizex2		"Patch 2 Inner Diameter (deg*10)"	20	0-300 1+
19	sizey2		"Patch 2 Outer Diameter (deg*10)"	60	0-400 1+
