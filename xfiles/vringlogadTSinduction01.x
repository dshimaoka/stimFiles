...
9	visOn		"frame start (s *10) even num"          10	0-2000 1+
10	visOff		"frame end   (s *10) even num"          11	0-2000 1+
11	sflog		"Flag for logaritmic or linear spacing"	0	0-1 1+
12	sfphase		"spatial phases"		        0	0-360 1+
13	seed		"Seed ...no use"	                1	0-32767 1+
