function SS = stimDynamicalClouds(myScreenInfo, Pars)
...
x = XFile('stimDynamicalClouds', pp);
...
rands = randn(128, 128, SS.nFrames);
rands = my_conv2(rands, [ss ss ts], [1 2 3]);
...
for iImage = 1:SS.nImages   
    ImageTextures{iImage} = rands(:,:,iImage);
end
