...
#	vringlogadPos.x
#
#		for retinotopy ringach experiments with adaptation
#		improved from vringlogad
#
...
4	diam		"Diameter (deg *10)"			20	1-400 1+
...
13	seed		"Seed for random number generator"	1	1-32767 1+
14	nfr		"Number of interpolated frames"		1	1-10 1+
