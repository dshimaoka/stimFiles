function SS = stimOptiWaveFlickChecks_AL(myScreenInfo,Pars)
...
% SS = stimOptiWaveFlickChecks(myScx
x
tlvsexit
reenInfo,Pars) returns an object SS of type ScreenStim
%
...
pp{18} = {'amp2',       'WAVE2: Amplitude (mV)',                   0,0,5000};
...
x = XFile('stimOptiWaveFlickChecks_NS',pp);
...
myScreenStimWav = ScreenStim.Make( myScreenInfo,'stimOptiWaveOutput_NS', ParsWav);
