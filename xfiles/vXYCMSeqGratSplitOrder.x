#
#	vXYCMSeqGratSplitOrder.x
#
#		square grating where the contrast polarity of small squares are modulated by mseq
#		contrast is now a variable; splits up the mseq into different overlapping parts 
#		you also manually specify the msequence order
#
...
13	nsplit		"the number of divisions (*2)"		4	2-8 2+
14	isplit		"the specific msequene part"		1	1-8 1+
15	order		"the order of the m-sequence"		9	8-16 1+
