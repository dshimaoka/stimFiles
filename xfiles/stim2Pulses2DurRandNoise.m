function SS = stim2Pulses2DurRandNoise(myScreenInfo,Pars)
...
x = XFile('stim2Pulses2DurRandNoise',pp);
...
SS.Type = 'stim2Pulses2DurRandNoise';
SS.Parameters = Pars;
...
SS = stim2Pulses2DurRandNoise(myScreenInfo); %#ok<UNRCH>
