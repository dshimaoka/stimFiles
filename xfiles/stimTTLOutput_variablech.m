...
pp{18} = {'Wave ch',    'DAQ ch number',    0,1,3};
pp{19} = {'TTL1 ch',    'DAQ ch number',    0,2,3};
pp{20} = {'TTL2 ch',    'DAQ ch number',    0,3,3};
...
if WaveAmp > 0
    ...
    SS.WaveStim.Waves(ntWavestart:ntWavestop-2,Wavech) = ...
...
elseif TTL1 || TTL2
    ...
    SS.WaveStim.Waves(ntTTL1start:ntTTL1stop-2,TTL1ch) = ...
        TTL1*2.5*( 1 + square(2*pi*TTL1Freq*ttTTL1, TTL1DurOn/1000*TTL1Freq*100)');
    SS.WaveStim.Waves(ntTTL2start:ntTTL2stop-2,TTL2ch) = ...
