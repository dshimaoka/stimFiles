function SS = stimLoadImg5(myScreenInfo,Pars)
...
pp{9}  = {'ip',     'which image database',                   5600,1,10000};
pp{10}  = {'nimg',  'total number of images',                 5600,1,10000};
pp{11}  = {'pbl',   'percentage blanks',                      5,0,100};

x = XFile('stimLoadImg5',pp);
