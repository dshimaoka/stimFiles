function SS = stimColorBar_DS20140430(myScreenInfo,Pars)
...
SS.ImageSequence(nFrames_pre+1:nFrames_pre+nFrames_stim) = SS.ImageSequence;
SS.ImageSequence(1:nFrames_pre) = SS.nImages;
SS.ImageSequence(nFrames_pre+nFrames_stim+1 : SS.nFrames) = SS.nImages;
...
myScreenStim2 = ScreenStim.Make(myScreenInfo,'stimColorBar_DS20140430'); %#ok<UNRCH>
