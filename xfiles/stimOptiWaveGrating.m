function SS = stimOptiWaveGrating(myScreenInfo,Pars)
...
x = XFile('stimOptiWaveGrating',pp);
...
myScreenStimVis = ScreenStim.Make( myScreenInfo,'stimGratingDelayed',   ParsVis);
