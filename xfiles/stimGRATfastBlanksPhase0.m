function SS = stimGRATfastBlanksPhase0(myScreenInfo,Pars)
...
pp{4}   = {'nPH',       'number of spatial phases',         6,1,100};
...
pp{9}   = {'stimD',     'Stimulus duration in frames',      6,0,100};
...
x = XFile('stimGRATfastBlanksPhase0', pp);
...
% add in 10% blanks for deconvolution
textid(rand(1, numel(textid))<0.1) = SS.nImages;
