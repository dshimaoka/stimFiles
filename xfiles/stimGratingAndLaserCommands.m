function SS = stimGratingAndLaserCommands(myScreenInfo,Pars)
...
x = XFile('stimGratingAndLaserCommands',pp);
...
SS = stimGratingAndLaserCommands(myScreenInfo);
