function SS = stimPlaid_2Contrasts(myScreenInfo,Pars)
...
cc1 	= Pars(11)/100;         % between 0 and 1
cc2 	= Pars(12)/100;         % between 0 and 1
mm 	= Pars(13)/100;     % between 0 and 1        
...
%     PlaidImage = ContrastImage.*WindowImage;
    PlaidImage = ...
            (imrotate(cc1.*ContrastImage, -angle/2 , 'crop') +...
            imrotate(cc2.*ContrastImage, +angle/2 , 'crop'))/2;
    ImageTextures{iImage} = ...
            uint8(255*mm*(1+PlaidImage.*WindowImage));
