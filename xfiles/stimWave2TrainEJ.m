function SS = stimWave2TrainEJ(myScreenInfo,Pars)
...
% 2014-12-09 DS made from stimWaveTrain
...
pp{6}  = {'WaveDurOn1',     'Duration of on period for wave (ms)',   20,0,1000};
...
RiseTime(1) = Pars(8)/1000; %s If 0, no truncation
