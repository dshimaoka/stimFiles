function SS = stimSparseNoise(myScreenInfo,Pars)
...
pp{2}  = {'x1',     'Left border, from center (deg*10)',     -400,-1400,1400};
pp{3}  = {'x2',     'Right border, from center (deg*10)',     400,-1400,1400};
...
pp{10} = {'sprsns',  'Percentage of gray squares (%*10)',     950,0,1000};
pp{11} = {'seed',   'Seed of random number generator',        1,1,100};

x = XFile('stimSparseNoise',pp);
...
for iImage = 1:SS.nImages
    ...
    im(randperm(nc * nr, ngs)) = 0; % set specified percentage of squares to mean gray
