function SS = stimGratingSATadapt(myScreenInfo,Pars)
...
pp{16}  = {'stimON',   'how long is the stimulus on',   50,0,100};
pp{17}  = {'reps',   'adaptation reps',   10,0,100};
x = XFile('stimGratingSATadapt',pp);
...
nFramesON = ceil(myScreenInfo.FrameRate*stimon );
...
SS.ImageSequence((nFramesON+1):SS.nFrames) = SS.nImages;

SS.ImageSequence = repmat(SS.ImageSequence, 1, nreps);
SS.nFrames = numel(SS.ImageSequence);
