function SS = stimWavePulseVisPulse(myScreenInfo,Pars)
...
x = XFile('stimWavePulseVisPulse',pp);
...
ParsWav = [Pars([1 14 15]); Pars([4 16 5 16 5]); 0; Pars(1)*100-5; 0];

myScreenStimVis = ScreenStim.Make( myScreenInfo,'stimFlashedGrat',ParsVis );
myScreenStimWav = ScreenStim.Make( myScreenInfo,'stimWaveOutput',ParsWav );
...
myScreenStim = ScreenStim.Make(myScreenInfo,'stimWavePulseVisPulse'); %#ok<UNRCH>
