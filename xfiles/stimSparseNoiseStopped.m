function SS = stimSparseNoiseStopped(myScreenInfo,Pars)
...
pp      = cell(1,1);
pp{1}   = {'dur',    'Stimulus duration (s *10)',              50,1,60000};
...
pp{12}  = {'tstart', 'Sparkling start (s*10)',                 0,1,100};
pp{13}  = {'tstopped','Sparkling stop (s*10)',                 30,1,600};

x       = XFile('stimSparseNoiseStopped', pp);
...
tonset        = Pars(12)/10;             % in seconds
toffset       = Pars(13)/10;             % in seconds
%% Make the stimulus
