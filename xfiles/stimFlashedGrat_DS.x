...
foo nonperiodic	12
#
0	dur	"               Stimulus duration (s *10)"	3	1-10000 1+
1	tf1	"              Temporal frequency (Hz*10)"	10	0-600 1+
...
7	x1	"              Focus position, x (deg*10)"	0	-1400-1400 1+
8	y1	"              Focus position, y (deg*10)"	0	-300-300 1+
9	ton	"                          onset time(ms)"	100	1-10000 1+
10	toff	"                         offset time(ms)"	200	1-10000 1+
