function SS = stimOptiChecksSine_NS2(myScreenInfo,Pars)
...
pp{2}  = {'tf1',   'Temporal frequency (Hz*10)',   10,   0,   200};
...
x = XFile('stimOptiGratSine_NS2',pp);
...
myScreenStimVis = ScreenStim.Make( myScreenInfo,'stimFlashedGrat_NS2', ParsVis);
