...
ParsWav = [Pars(1); Pars(nparvis + (1:6)); Pars(nparvis + (1:6));  Pars(nparvis + 7)];

myScreenStimVis = ScreenStim.Make( myScreenInfo,'stimGratingWithDelay',   ParsVis); %stimGratingDelayed
myScreenStimWav = ScreenStim.Make( myScreenInfo,'stimOptiWaveOutput_DS', ParsWav); %stimOptiWaveOutput_MP
