...
Pars1 = [ Pars(1:4); Pars(6); Pars(6:9);  Pars(9); Pars(1)*100-5; Pars(12); 0 ];

Pars2 = [ Pars(1:7); Pars(10:11); Pars(11); Pars(1)*100-5; Pars(13); 0 ];
...
myScreenStim = ScreenStim.Make(myScreenInfo,'stimTwoFlashedBars'); %#ok<UNRCH>
