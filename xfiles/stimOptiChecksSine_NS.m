...
pp{12} = {'amp1',       'WAVE1: Amplitude (mV)',                   0,0,5000};
pp{13} = {'freq1',      'WAVE1: Frequency of pulses (Hz*10)',      10,0,1000};
pp{14} = {'tailDuration',    'WAVE1: Tail Duration (ms, 0 for none)',   200, 0 10000}; 
pp{15} = {'trigtype',   'Manual(1), HwDigital(2), Immediate(3)',   1, 1, 3};

x = XFile('stimOptiChecksSine_NS',pp);
...
ParsWav = [Pars(1); Pars(10:15)];

myScreenStimVis = ScreenStim.Make( myScreenInfo,'oglFlickeringChecks_NS', ParsVis);
...
myScreenStim = ScreenStim.Make(myScreenInfo,'stimOptiChecksSine_NS'); %#ok<UNRCH>
